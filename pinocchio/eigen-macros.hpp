...
#define PINOCCHIO_EIGEN_PLAIN_COLUMN_MAJOR_TYPE(D) \
    pinocchio::helper::handle_return_type_without_typename<D, Eigen::internal::plain_matrix_type_column_major>::type
...
#define PINOCCHIO_EIGEN_PLAIN_ROW_MAJOR_TYPE(D) \
    pinocchio::helper::                         \
        handle_return_type_without_typename<D, ::pinocchio::fix::Eigen::internal::plain_matrix_type_row_major>::type
...
#define PINOCCHIO_EIGEN_REF_TYPE(D) \
    Eigen::internal::conditional<bool(Eigen::internal::traits<D>::Flags & Eigen::NestByRefBit), D&, D>::type
#endif
...
#define PINOCCHIO_EIGEN_DOT_PRODUCT_RETURN_TYPE(D1, D2)                       \
    Eigen::ScalarBinaryOpTraits<typename Eigen::internal::traits<D1>::Scalar, \
                                typename Eigen::internal::traits<D2>::Scalar>::ReturnType
#else
#define PINOCCHIO_EIGEN_DOT_PRODUCT_RETURN_TYPE(D1, D2)                                  \
    Eigen::internal::scalar_product_traits<typename Eigen::internal::traits<D1>::Scalar, \
                                           typename Eigen::internal::traits<D2>::Scalar>::ReturnType
#endif
