...
void LieGroupBase<Derived>::integrate(const Eigen::MatrixBase<ConfigIn_t>& q,
...
void LieGroupBase<Derived>::integrateCoeffWiseJacobian(const Eigen::MatrixBase<Config_t>& q,
...
template <class Derived>
template <class Config_t, class Tangent_t, class JacobianOut_t>
void LieGroupBase<Derived>::dIntegrate_dq(const Eigen::MatrixBase<Config_t>& q,
                                          const Eigen::MatrixBase<Tangent_t>& v,
                                          const Eigen::MatrixBase<JacobianOut_t>& J,
                                          const AssignmentOperatorType op) const
{
    ...
    derived().dIntegrate_dq_impl(q.derived(), v.derived(), PINOCCHIO_EIGEN_CONST_CAST(JacobianOut_t, J), op);
}
                                          ...
                                          const AssignmentOperatorType op) const
{
    ...
    derived().dIntegrate_product_impl(
        q.derived(), v.derived(), Jin.derived(), PINOCCHIO_EIGEN_CONST_CAST(JacobianOut_t, Jout), false, ARG0, op);
}
                                          ...
                                          const AssignmentOperatorType op) const
{
    ...
    derived().dIntegrate_product_impl(
        q.derived(), v.derived(), Jin.derived(), PINOCCHIO_EIGEN_CONST_CAST(JacobianOut_t, Jout), true, ARG0, op);
}

template <class Derived>
template <class Config_t, class Tangent_t, class JacobianOut_t>
void LieGroupBase<Derived>::dIntegrate_dv(const Eigen::MatrixBase<Config_t>& q,
                                          const Eigen::MatrixBase<Tangent_t>& v,
                                          const Eigen::MatrixBase<JacobianOut_t>& J,
                                          const AssignmentOperatorType op) const
{
    ...
    EIGEN_STATIC_ASSERT_SAME_VECTOR_SIZE(Tangent_t, TangentVector_t);
    EIGEN_STATIC_ASSERT_SAME_VECTOR_SIZE(JacobianOut_t, JacobianMatrix_t);
    derived().dIntegrate_dv_impl(q.derived(), v.derived(), PINOCCHIO_EIGEN_CONST_CAST(JacobianOut_t, J), op);
}
                                          ...
                                          const AssignmentOperatorType op) const
{
    ...
    assert(Jout.rows() == Jin.rows());
    derived().dIntegrate_product_impl(
        q.derived(), v.derived(), Jin.derived(), PINOCCHIO_EIGEN_CONST_CAST(JacobianOut_t, Jout), false, ARG1, op);
}
                                          ...
                                          const AssignmentOperatorType op) const
{
    ...
    assert(Jout.cols() == Jin.cols());
    derived().dIntegrate_product_impl(
        q.derived(), v.derived(), Jin.derived(), PINOCCHIO_EIGEN_CONST_CAST(JacobianOut_t, Jout), true, ARG1, op);
}
                                                   ...
                                                   const Eigen::MatrixBase<Jacobian_t>& J) const
{
    ...
    EIGEN_STATIC_ASSERT_SAME_VECTOR_SIZE(Tangent_t, TangentVector_t);
    // EIGEN_STATIC_ASSERT_SAME_VECTOR_SIZE(JacobianOut_t, JacobianMatrix_t);
    derived().dIntegrateTransport_dq_impl(q.derived(), v.derived(), PINOCCHIO_EIGEN_CONST_CAST(Jacobian_t, J));
}
                                                   ...
                                                   const Eigen::MatrixBase<Jacobian_t>& J) const
{
    ...
    EIGEN_STATIC_ASSERT_SAME_VECTOR_SIZE(Tangent_t, TangentVector_t);
    // EIGEN_STATIC_ASSERT_SAME_VECTOR_SIZE(JacobianOut_t, JacobianMatrix_t);
    derived().dIntegrateTransport_dv_impl(q.derived(), v.derived(), PINOCCHIO_EIGEN_CONST_CAST(Jacobian_t, J));
}
...
void LieGroupBase<Derived>::interpolate(const Eigen::MatrixBase<ConfigL_t>& q0,
...
template <class Derived>
template <class Config_t>
bool LieGroupBase<Derived>::isNormalized(const Eigen::MatrixBase<Config_t>& qin, const Scalar& prec) const
{
    EIGEN_STATIC_ASSERT_SAME_VECTOR_SIZE(Config_t, ConfigVector_t);
...
template <class Derived>
template <class ConfigL_t, class ConfigR_t, class ConfigOut_t>
void LieGroupBase<Derived>::randomConfiguration(const Eigen::MatrixBase<ConfigL_t>& lower_pos_limit,
                                                ...
                                                const Eigen::MatrixBase<ConfigOut_t>& qout) const
{
    ...
    derived().randomConfiguration_impl(
        lower_pos_limit.derived(), upper_pos_limit.derived(), PINOCCHIO_EIGEN_CONST_CAST(ConfigOut_t, qout));
}

template <class Derived>
template <class ConfigL_t, class ConfigR_t, class Tangent_t>
void LieGroupBase<Derived>::difference(const Eigen::MatrixBase<ConfigL_t>& q0,
                                       const Eigen::MatrixBase<ConfigR_t>& q1,
                                        ...
                                        const AssignmentOperatorType op) const
{
    ...
    derived().template dDifference_product_impl<arg>(
        q0.derived(), q1.derived(), Jin.derived(), PINOCCHIO_EIGEN_CONST_CAST(JacobianOut_t, Jout), false, op);
}
                                        ...
                                        const AssignmentOperatorType op) const
{
    ...
    assert(Jout.cols() == Jin.cols());
    derived().template dDifference_product_impl<arg>(
        q0.derived(), q1.derived(), Jin.derived(), PINOCCHIO_EIGEN_CONST_CAST(JacobianOut_t, Jout), true, op);
}
...
template <class Derived>
template <class ConfigL_t, class ConfigR_t>
typename LieGroupBase<Derived>::Scalar LieGroupBase<Derived>::distance(const Eigen::MatrixBase<ConfigL_t>& q0,
                                                                       const Eigen::MatrixBase<ConfigR_t>& q1) const
{
...
template <class Derived>
template <class ConfigL_t, class ConfigR_t>
bool LieGroupBase<Derived>::isSameConfiguration(const Eigen::MatrixBase<ConfigL_t>& q0,
                                                const Eigen::MatrixBase<ConfigR_t>& q1,
...
template <class Derived>
template <class Config_t, class Tangent_t, class JacobianIn_t, class JacobianOut_t>
void LieGroupBase<Derived>::dIntegrate_product_impl(const Config_t& q,
                                                    const Tangent_t& v,
...
template <class Derived>
template <class ConfigL_t, class ConfigR_t, class ConfigOut_t>
void LieGroupBase<Derived>::interpolate_impl(const Eigen::MatrixBase<ConfigL_t>& q0,
                                             const Eigen::MatrixBase<ConfigR_t>& q1,
                                             const Scalar& u,
                                             const Eigen::MatrixBase<ConfigOut_t>& qout) const
{
    if (u == 0)
        PINOCCHIO_EIGEN_CONST_CAST(ConfigOut_t, qout) = q0;
    else if (u == 1)
        PINOCCHIO_EIGEN_CONST_CAST(ConfigOut_t, qout) = q1;
    else
    {
...
template <class Derived>
template <class ConfigL_t, class ConfigR_t>
bool LieGroupBase<Derived>::isSameConfiguration_impl(const Eigen::MatrixBase<ConfigL_t>& q0,
                                                     const Eigen::MatrixBase<ConfigR_t>& q1,
                                                     const Scalar& prec) const
{
